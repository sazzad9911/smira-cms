...
const Poster = () => {
    ...
    const save=()=>{
        if(!ImageSize){
            setError("Select 900*900 image file")
            return;
        }
        if(!Files || !selected){
            ...
            <div className="card">
              <div className="card-body">
                  ...
                  <div className="row">
                    <div className="col-md-6">
                      <Form.Group className="row">
                        ...
                        <Form.Control placeholder='optional' onChange={(e)=>setName(e.target.value)}  type="text" />
                        </div>
                      </Form.Group>
                    </div>
                    <div className="col-md-6">
                ...
                <div className="row">
                    ...
                    <div className="col-md-6">
                      <Form.Group className="row">
                        <label className="col-sm-3 col-form-label">Add Poster Image-900*900</label>
                        <div className="col-sm-9">
